...
class PlatformService
{
	...
	public function __construct($serviceContext)
	{
		...
		{
			throw new Exception('Resources.ServiceContextCannotBeNull');
		}

		if (!is_object($serviceContext))
		{
			throw new Exception('Wrong arg type passed - is not an object.');
		}

		if (0 !== strcmp('ServiceContext',get_class($serviceContext)))
		{
			throw new Exception('Wrong arg type passed - is not the correct class.');
		}
	...
	public function GetAppMenu()
	{
		...
		$result = $this->restRequestHandler->GetResponse($requestParameters, $this->requestXmlDocument, NULL);
