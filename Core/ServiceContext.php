...
class ServiceContext
{
	...
	public function getSimproDebug()
	{
		return $this->simproDebug;
	}

	public function setSimproDebug($simproDebug)
	{
		$this->simproDebug = $simproDebug;
	}
	 ...
	 */
	 public function __construct($realmId, $serviceType, $requestValidator = NULL, $debug = true)
	 {
